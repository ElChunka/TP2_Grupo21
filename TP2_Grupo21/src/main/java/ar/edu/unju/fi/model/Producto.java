...
public class Producto {
	...
	@Size(min=4,max=30,message="La categoria del nuevo producto debe tener entre entre 4 y 3o caracteres")
	@NotBlank(message="La categoria debe ser descripta en una sola palabra")
